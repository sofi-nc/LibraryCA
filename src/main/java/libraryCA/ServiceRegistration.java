...
public class ServiceRegistration {
	public static void main(String[] args) throws InterruptedException {
		...
		try {
			...
			ServiceInfo LightsInfo = ServiceInfo.create("_http._tcp.local.", "Lighting", 50051, "path=index.html");
			...
			ServiceInfo SearchInfo = ServiceInfo.create("_http._tcp.local.", "SearchEngine", 50052, "path=index.html");
			...
			ServiceInfo RegistrationInfo = ServiceInfo.create("_http._tcp.local.", "Registration", 50053, "path=index.html");
